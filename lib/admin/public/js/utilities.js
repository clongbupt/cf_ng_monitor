...
var Utilities =
{
    ...
    buildStatsData: function(items)
    {
        ...
        for (var index in items)
        {
            ...
            usersWithAppsEntry.push(entryDate);
            ...
            if (item.users_with_apps > 0)
            {
                usersWithAppsEntry.push(item.users_with_apps);    
                usersWithAppsLine.push(usersWithAppsEntry);
            }
        ...
        return [totalInstancesLine, runningInstancesLine, appsLine, usersLine, usersWithAppsLine];  
    },
        ...
        return $.jqplot(chartID, 
                        data, 
                        {
                            ...
                            [
                                ...
                                Utilities.getChartSeries("rgba(  0,  85, 135, 0.8)")
                            ],
                            legend:
                            {
                                show:true,
                                ...
                                location: "nw",
                                labels: ["Total Instances", "Running Instances", "Total Apps", "Total Users", "Users with Apps"],
