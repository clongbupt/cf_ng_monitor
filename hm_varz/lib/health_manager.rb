...
require 'health_manager/user_info'

module HealthManager
  class Manager
    include HealthManager::Common

    attr_reader :varz, :actual_state, :desired_state, :droplet_registry, :reporter, :nudger, :publisher, :harmonizer, :user_info
